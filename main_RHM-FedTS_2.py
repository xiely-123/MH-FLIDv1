...
from untils.Update_RHM_FedTS_2 import LocalUpdate

import model_1.ResNet_FedTS_2_RHM as ResNet
import model_1.shufflenetv2_FedTS as shufflenetv2
import model_1.ResNeXt_FedTS as ResNeXt
import model_1.squeezeNet_FedTS as squeezeNet
import model_1.SENet_FedTS as SENet
import model_1.MobileNet_FedTS as MobileNet
import model_1.DenseNet_FedTS as DenseNet
import model_1.VGG_FedTS as VGG


from untils.utils import average_weights, exp_details, get_dataset
from untils.utils_iid_noiid import get_dataset_v2, get_dataset_personal
...
if __name__ == '__main__':
    ...
    # BUILD MODEL
    num_classes = 8
    global_model_0 = ResNet.ResNet11(num_classes)
   ...
   # global_model_7 = VGG.vgg11_bn(num_classes)
