...
def args_parser():
    ...
    parser.add_argument('--local_TS_ep', type=int, default=5,
                        help="the number of local epochs: E")
    parser.add_argument('--local_bs', type=int, default=2,
                        help="local batch size: B")
    parser.add_argument('--lr', type=float, default=0.001,
                        help='learning rate')
    parser.add_argument('--lr_s', type=float, default=0.001,
                        help='learning rate ts')
    ...
    # other arguments
    parser.add_argument('--num_classes', type=int, default=8, help="number \
                        of classes")
    ...
    parser.add_argument('--stopping_rounds', type=int, default=1,
                        help='rounds of early stopping')
    parser.add_argument('--verbose', type=int, default=1, help='verbose')
    parser.add_argument('--seed', type=int, default=512, help='random seed')
    parser.add_argument('--task', type=str, default='breast', help="breast")
